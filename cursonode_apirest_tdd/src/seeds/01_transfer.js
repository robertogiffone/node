exports.seed = (knex) => {
  return knex('transactions').del()
    ...
    .then(() => knex('users').insert([
      {
        id: 10000, name: 'User #1', email: 'user10000@mail.com', passwd: '$2a$10$BKWBistO5ExZbFFMfS7hPusyJRon6ayOmNoGG25NezVZ1WVwZ8txu',
      },
      {
        id: 10001, name: 'User #2', email: 'user10001@mail.com', passwd: '$2a$10$BKWBistO5ExZbFFMfS7hPusyJRon6ayOmNoGG25NezVZ1WVwZ8txu',
      },
    ]))
